...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MBLocationDAO locationsJdbc = new MBLocationDAO();
        MBBranchDAO branchesJdbc = new MBBranchDAO();
        MBAssociateDAO associatesJdbc = new MBAssociateDAO();
        MBPositionDOA positionsJdbc = new MBPositionDOA();
        MBStaffDAO staffJdbc = new MBStaffDAO();
